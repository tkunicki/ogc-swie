          ...
          <gml:upperCorner>-89.2 43.3</gml:upperCorner>
						...
						<li>
							<dl>
								...
								<dd>
									<p>Jordan, the only way I know how to do this is via the XMLHTTPRequest object,
									calling the "send()" method with the actual XML string as the argument.
									You can ask John Hollister if there's a better way.</p>
									
									<p>The slight complication is that the resulting xml doesn't replace the page,
									so you might have to put it into a textarea to display it. I'll leave it up to you.
									I don't care if it's polished, and I don't care if it works with all browsers.
									Feel free to use this as a learning opportunity.</p>
