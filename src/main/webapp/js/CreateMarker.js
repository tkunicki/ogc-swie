function createMarker(point, name, StateNM, Site_no, USGS_URL, base_url, watershed)
{
    ...
    GEvent.addListener(marker, "click", function() {
        ...
        var gdaDV_url = base_url + "/sos?request=GetDataAvailablity&featureID=" + Site_no;
        ...
        document.getElementById("AvailableDataHeader").innerHTML = html_header + '<br /><b>Available Data:</b><br />';
